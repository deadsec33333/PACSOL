...
function drawPacman() { 
    ...
    // Create the gradient
    var gradient = ctx.createLinearGradient(PACMAN_POSITION_X - PACMAN_SIZE, PACMAN_POSITION_Y, PACMAN_POSITION_X + PACMAN_SIZE, PACMAN_POSITION_Y);
    gradient.addColorStop(0, "#0cf3a8"); // Starting color (left)
    gradient.addColorStop(1, "#d823fd"); // Ending color (right)
